function [fd,fdt] = fanduel()
% http://undocumentedmatlab.com/blog/expanding-urlreads-capabilities
clc; close all; clear; 

% URLfull = 'https://www.fanduel.com/games/13428/contests/13428-17838390/enter'
% https://www.fanduel.com/nextnflgame
URLbase = 'https://www.fanduel.com/';
URLcontest = 'nextnflgame';
URLfull = strcat(URLbase,  URLcontest);



html_firstname = 'player-position';

% Open connection to FanDuel page
fprintf(1,'Retrieving player data for contest %s...', URLcontest);
